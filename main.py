...
def display_page():
    ...
    if st.session_state.page_state == 0:
        ...
        st.write("This program is loosely inspired by iQuiz, a game on Apple iPods that quizzes you on random songs, albums and artists from your iPod library. This program does exactly that, but uses Spotify playlists instead. There are 10 questions, you get 3 lives, and do be warned there is auto-playing audio.\n\nTo begin testing your knowledge on the songs you like, enter a link to a Spotify playlist below! (P.S. the larger the playlist, the better the experience)")
